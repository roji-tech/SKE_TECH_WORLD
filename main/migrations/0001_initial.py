    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('ART', 'Art Class'), ('SCIENCE', 'Science Class'), ('SCIENCE_TECH', 'Science and Technology Class'), ('COMMERCIAL', 'Commercial Class')], max_length=12, null=True)),
